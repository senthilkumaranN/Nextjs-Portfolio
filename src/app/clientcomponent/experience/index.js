                    ...
                    <AnimationWrapper>
                        <div className="flex w-full">
                            <motion.div className="container">
                                <Timeline variant="outlined" position="right">
                                    {experienceData && experienceData.length
                                        ? experienceData.map((experienceItem) => (
                                            <TimelineItem key={experienceItem._id}>
                                                <TimelineSeparator>
                                ...
                                <Timeline variant="outlined" position="right">
                                    {educationData && educationData.length
                                        ? educationData.map((educationItem) => (
                                            <TimelineItem key={educationItem._id}>
                                                <TimelineSeparator>
                                                    <TimelineDot variant="outlined" className="border-green-main" />
                                                    <TimelineConnector variant="outlined" className="bg-green-main" />
                                                </TimelineSeparator>
                                                <TimelineContent>
                                                    <div className="border-[2px] p-4 rounded-[8px] border-green-main mt-[14px] ml-[16px]">
                                                        <p className="font-bold">
