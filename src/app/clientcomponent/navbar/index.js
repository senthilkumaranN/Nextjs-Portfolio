        ...
        <>
            <header className={`fixed top-0 w-full z-30 bg-white-500 transition-all ${scrollactive ? "shadow-md pt-0 " : "pt-4"
                ...
                <nav className="max-w-screen-xl px-6 sm:px-8 lg:px-16 mx-auto grid grid-flow-col py-3 sm:py-4">
                    ...
                    text-green-main">
                            <div className="w-[40px] h-[40px] flex justify-center items-center p-3 rounded-[8px]
                    ...
                    <div className="col-start-10 col-end-12 font-medium flex justify-center items-center">
                        <button className="py-3 px-6 border-[2px] bg-[#fff] border-green-main text-[#000] font-semibold rounded-lg text-xl tracking-widest
                         hover:bg-green-main transition-all outline-none"
                         onClick={() =>
            ...
            <nav className="fixed lg:hidden bottom-0 left-0 right-0 z-20 px-4 sm:px-8 shadow-sm">
